...
def nbr_upperletters(object: str)-> int:
	'''This function takes a string as an argument and returns the number of upper letters in the string'''
	upper = 0
	for c in object:
		if (c.isupper()):
			upper += 1
...
def nbr_lowerletters(object: str)-> int:
	'''This function takes a string as an argument and returns the number of lower letters in the string'''
	lower = 0
	for c in object:
		if (c.islower()):
			lower += 1
...
def nbr_punctuationmarks(object: str)-> int:
	'''This function takes a string as an argument and returns the number of punctuation marks in the string'''
	punct = 0
	for c in object:
		if (c in ".,;:!?-"):
			punct += 1
...
def nbr_spaces(object: str)-> int:
	'''This function takes a string as an argument and returns the number of spaces in the string'''
	spaces = 0
	for c in object:
		if (c.isspace()):
			spaces += 1
...
def str_composition(object: str)-> int:
	'''This function takes a string as an argument and returns the number of characters, upper letters, lower letters, punctuation marks, spaces and digits in the string.'''
	nbr_chr(object)
